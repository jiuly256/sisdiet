...
<html lang="en">
  <head>
	...
	<!--link href='http://fonts.googleapis.com/css?family=Carrois+Gothic' rel='stylesheet' type='text/css'-->
        <link href="<?php echo Yii::app()->theme->baseUrl;?>/css/gotico.css" rel='stylesheet' type='text/css'>
        <!-- Busca la fuente en googleapis //CAMB -->
        <link href="<?php echo Yii::app()->theme->baseUrl;?>/css/fonts/FontAwesome/fontawesome.css" rel='stylesheet' type='text/css'>
	...
	<?php  
      ...
      <!-- styles for style switcher -->
      	<link rel="stylesheet" type="text/css" href="<?php echo $baseUrl;?>/css/style-light_blue.css" />
