...
-- Started on 2016-10-04 07:07:46 VET
...
--
-- TOC entry 208 (class 3079 OID 11645)
...
--
-- TOC entry 221 (class 1255 OID 74705)
-- Dependencies: 6 636
...
--
-- TOC entry 220 (class 1255 OID 74704)
-- Dependencies: 6 636
...
--
-- TOC entry 207 (class 1259 OID 123871)
-- Dependencies: 6
-- Name: dieta_subdieta; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.dieta_subdieta OWNER TO postgres;

--
-- TOC entry 206 (class 1259 OID 123869)
-- Dependencies: 207 6
-- Name: dieta_subdieta_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE dieta_subdieta_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.dieta_subdieta_id_seq OWNER TO postgres;

--
-- TOC entry 2139 (class 0 OID 0)
-- Dependencies: 206
-- Name: dieta_subdieta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE dieta_subdieta_id_seq OWNED BY dieta_subdieta.id;
...
--
-- TOC entry 203 (class 1259 OID 115664)
-- Dependencies: 6
...
--
-- TOC entry 205 (class 1259 OID 115671)
-- Dependencies: 1920 6
...
--
-- TOC entry 204 (class 1259 OID 115669)
-- Dependencies: 205 6
...
--
-- TOC entry 201 (class 1259 OID 91101)
-- Dependencies: 2082 6
...
--
-- TOC entry 202 (class 1259 OID 99286)
-- Dependencies: 2083 6
-- Name: vistadetalle; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW vistadetalle AS
    SELECT a.id, a.fecha, b.nombre AS nombre_mascota, b.clasificacion, b.peso, e.descripcion AS medida, d.tipo, d.descripcion, c.nombre, c.apellido, (SELECT vistaporcion.cantidad_gramos FROM vistaporcion WHERE (((vistaporcion.cantidad >= b.peso) AND (vistaporcion.cantidad <= (SELECT (b.peso + (5)::double precision)))) AND ((vistaporcion.tipo)::text = (d.tipo)::text)) LIMIT 1) AS porcion, (SELECT vistaporcion.porcentaje_proteina FROM vistaporcion WHERE (((vistaporcion.cantidad >= b.peso) AND (vistaporcion.cantidad <= (SELECT (b.peso + (5)::double precision)))) AND ((vistaporcion.tipo)::text = (d.tipo)::text)) LIMIT 1) AS porcentaje_proteina, (SELECT vistaporcion.porcentaje_vegetal FROM vistaporcion WHERE (((vistaporcion.cantidad >= b.peso) AND (vistaporcion.cantidad <= (SELECT (b.peso + (5)::double precision)))) AND ((vistaporcion.tipo)::text = (d.tipo)::text)) LIMIT 1) AS porcentaje_vegetal FROM dieta a, mascota b, cliente c, edad_mascota d, unidad_medida e WHERE ((((b.id_mascota = a.id_mascota) AND (c.id = a.id_cliente)) AND (b.peso_medida = e.id)) AND (b.clasificacion = d.id));


ALTER TABLE public.vistadetalle OWNER TO postgres;

--
-- TOC entry 200 (class 1259 OID 91097)
-- Dependencies: 2081 6
...
--
-- TOC entry 1899 (class 2604 OID 64139)
...
--
-- TOC entry 1900 (class 2604 OID 64140)
...
--
-- TOC entry 1901 (class 2604 OID 64141)
...
--
-- TOC entry 1902 (class 2604 OID 64142)
...
--
-- TOC entry 1921 (class 2604 OID 123874)
-- Dependencies: 206 207 207
-- Name: id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY dieta_subdieta ALTER COLUMN id SET DEFAULT nextval('dieta_subdieta_id_seq'::regclass);


--
-- TOC entry 1904 (class 2604 OID 64143)
...
--
-- TOC entry 1918 (class 2604 OID 64555)
...
--
-- TOC entry 1905 (class 2604 OID 64144)
...
--
-- TOC entry 1906 (class 2604 OID 64145)
...
--
-- TOC entry 1907 (class 2604 OID 64146)
...
--
-- TOC entry 1908 (class 2604 OID 64147)
...
--
-- TOC entry 1909 (class 2604 OID 64148)
...
--
-- TOC entry 1910 (class 2604 OID 64149)
...
--
-- TOC entry 1911 (class 2604 OID 64150)
...
--
-- TOC entry 1912 (class 2604 OID 64151)
...
--
-- TOC entry 1913 (class 2604 OID 64155)
...
--
-- TOC entry 1914 (class 2604 OID 64156)
...
--
-- TOC entry 1915 (class 2604 OID 64157)
...
--
-- TOC entry 1919 (class 2604 OID 115674)
...
--
-- TOC entry 1917 (class 2604 OID 64158)
...
--
-- TOC entry 2084 (class 0 OID 64022)
-- Dependencies: 161 2127
...
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (32, 'PAPA', 2, NULL, 1, NULL);
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (11, 'LECHOSA', 5, NULL, 1, NULL);
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (33, 'PAPILLAS', 7, NULL, 5, NULL);
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (35, 'ENVASE GRANDE', 0, NULL, 5, NULL);
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (34, 'ENVASE PEQUEÑO', 0, NULL, 5, NULL);
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (36, 'HIGADO PREMIO', 7, NULL, 5, NULL);
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (37, 'CALDOS', 7, NULL, 5, NULL);
INSERT INTO alimento (id, descripcion, tipo_alimento, observaciones, id_unidad, cantidad) VALUES (38, 'ENVASE MEDIANO', 0, NULL, 5, NULL);
...
SELECT pg_catalog.setval('alimento_id_seq', 38, true);


--
-- TOC entry 2086 (class 0 OID 64027)
-- Dependencies: 163 2127
...
INSERT INTO cliente (id, cedula, nombre, apellido, sexo, direccion, telefono, telefono_casa, correo_electronico, created_date, modified_date, created_by, modified_by) VALUES (4, 22615011, 'Carlos', 'Castillo', 2, 'El Paraiso', '(2222)-222-2222', '(3333)-333-3333', '', '2016-09-04', '2016-09-04', 2, 2);
INSERT INTO cliente (id, cedula, nombre, apellido, sexo, direccion, telefono, telefono_casa, correo_electronico, created_date, modified_date, created_by, modified_by) VALUES (5, 1234, 'Carla', 'Perez', 1, 'El Hatilo', '(2222)-222-2222', '', '', '2016-10-02', '2016-10-02', 2, 2);
INSERT INTO cliente (id, cedula, nombre, apellido, sexo, direccion, telefono, telefono_casa, correo_electronico, created_date, modified_date, created_by, modified_by) VALUES (6, 19519653, 'Maira', 'Perez', 1, 'Guarenas', '(0424)-252-1525', '', '', '2016-10-02', '2016-10-02', 2, 2);
...
--
-- TOC entry 2088 (class 0 OID 64035)
-- Dependencies: 165 2127
-- Data for Name: dieta; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO dieta (id, fecha, id_cliente, id_mascota, precio_diario, dias, precio_dias, iva, monto_iva, precio_total, created_date, modified_date, created_by, modified_by) VALUES (83, '2016-10-03', 1, 1, 8719.98999999999978, 1, 17219.9900000000016, 12, 2066.39879999999994, 19286.3888000000006, '2016-10-04', '2016-10-04', 2, 2);


--
-- TOC entry 2089 (class 0 OID 64038)
-- Dependencies: 166 2127
-- Data for Name: dieta_detalle; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (837, 83, 2, 111.299999999999997, 2.5, 278.25, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (838, 83, 18, 23.8500000000000014, 0.900000000000000022, 21.4649999999999999, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (839, 83, 17, 23.8500000000000014, 0.849999999999999978, 20.2725000000000009, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (840, 83, 37, 3, 1600, 4800, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (841, 83, 36, 1, 700, 700, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (842, 83, 33, 2, 1500, 3000, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (843, 83, 35, 2, 1200, 2400, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (844, 83, 38, 6, 1000, 6000, '2016-10-04', '2016-10-04', 2, 2, 10);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (845, 83, 2, 111.299999999999997, 2.5, 278.25, '2016-10-04', '2016-10-04', 2, 2, 11);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (846, 83, 18, 23.8500000000000014, 0.900000000000000022, 21.4649999999999999, '2016-10-04', '2016-10-04', 2, 2, 11);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (847, 83, 17, 23.8500000000000014, 0.849999999999999978, 20.2725000000000009, '2016-10-04', '2016-10-04', 2, 2, 11);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (848, 83, 35, 2, 1200, 2400, '2016-10-04', '2016-10-04', 2, 2, 11);
INSERT INTO dieta_detalle (id, id_dieta, id_alimento, cantidad_gramos, costo_gramos, precio_gramos, created_date, modified_date, created_by, modified_by, id_subdieta) VALUES (849, 83, 38, 6, 1000, 6000, '2016-10-04', '2016-10-04', 2, 2, 11);
...
SELECT pg_catalog.setval('dieta_detalle_id_seq', 849, true);
...
SELECT pg_catalog.setval('dieta_id_seq', 83, true);


--
-- TOC entry 2126 (class 0 OID 123871)
-- Dependencies: 207 2127
-- Data for Name: dieta_subdieta; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO dieta_subdieta (id, id_dieta, descripcion, monto, dias, total) VALUES (11, 83, 'DIETA NUTRIPETS', NULL, NULL, NULL);
INSERT INTO dieta_subdieta (id, id_dieta, descripcion, monto, dias, total) VALUES (10, 83, 'DIETA NUTRIPETS', 8719.98999999999978, 1, 8719.98999999999978);


--
-- TOC entry 2160 (class 0 OID 0)
-- Dependencies: 206
-- Name: dieta_subdieta_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('dieta_subdieta_id_seq', 11, true);
...
--
-- TOC entry 2093 (class 0 OID 64047)
-- Dependencies: 170 2127
...
--
-- TOC entry 2121 (class 0 OID 64552)
-- Dependencies: 198 2127
...
INSERT INTO entrada_almacen (id, fecha, observacion) VALUES (6, '2016-10-02', 'premios');
INSERT INTO entrada_almacen (id, fecha, observacion) VALUES (7, '2016-10-02', 'envases');
...
SELECT pg_catalog.setval('entrada_almacen_id_seq', 7, true);


--
-- TOC entry 2095 (class 0 OID 64052)
-- Dependencies: 172 2127
...
INSERT INTO mascota (id_mascota, id_cliente, nombre, tipo, raza, fecha_nacimiento, edad, clasificacion, sexo, color, esterilizado, longitud, longitud_medida, peso, peso_medida, foto, observacion, created_date, modified_date, created_by, modified_by) VALUES (1, 1, 'Molly', 1, 210, '2015-05-15', 1, 3, 3, 'típico, plateado con marron', 2, 25, 2, 3.5, 1, '', 'Le encanta la zanahoria', '2016-08-18', '2016-09-03', 1, 1);
INSERT INTO mascota (id_mascota, id_cliente, nombre, tipo, raza, fecha_nacimiento, edad, clasificacion, sexo, color, esterilizado, longitud, longitud_medida, peso, peso_medida, foto, observacion, created_date, modified_date, created_by, modified_by) VALUES (4, 1, 'Ceniza', 1, 150, '2013-09-05', 35, 5, 3, 'gris', 2, 35, 2, 13, 1, '', '', '2016-09-02', '2016-09-04', 1, 2);
INSERT INTO mascota (id_mascota, id_cliente, nombre, tipo, raza, fecha_nacimiento, edad, clasificacion, sexo, color, esterilizado, longitud, longitud_medida, peso, peso_medida, foto, observacion, created_date, modified_date, created_by, modified_by) VALUES (7, 5, 'Linda', 1, 210, '2016-10-06', NULL, 1, 3, 'blanca', 2, 1, 2, 2, 1, '', '', '2016-10-02', '2016-10-02', 2, 2);
INSERT INTO mascota (id_mascota, id_cliente, nombre, tipo, raza, fecha_nacimiento, edad, clasificacion, sexo, color, esterilizado, longitud, longitud_medida, peso, peso_medida, foto, observacion, created_date, modified_date, created_by, modified_by) VALUES (8, 6, 'Rocco', 1, 210, '2015-03-12', NULL, 3, 4, 'típico, plateado con marron', 2, 12, 2, 3, 1, '', '', '2016-10-02', '2016-10-02', 2, 2);
...
SELECT pg_catalog.setval('mascota_id_mascota_seq', 8, true);


--
-- TOC entry 2122 (class 0 OID 115664)
-- Dependencies: 203 2127
-- Data for Name: migration; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO migration (version, apply_time) VALUES ('m000000_000000_base', 1474934457);
INSERT INTO migration (version, apply_time) VALUES ('m130524_201442_init', 1474934459);


--
-- TOC entry 2097 (class 0 OID 64060)
-- Dependencies: 174 2127
...
--
-- TOC entry 2099 (class 0 OID 64065)
-- Dependencies: 176 2127
...
--
-- TOC entry 2101 (class 0 OID 64070)
-- Dependencies: 178 2127
...
INSERT INTO porcion (id, id_peso, id_edad, cantidad_gramos, porcentaje_grasa, porcentaje_proteina, porcentaje_vegetal) VALUES (6, 2, 1, 500, 0, 60, 40);
...
--
-- TOC entry 2103 (class 0 OID 64075)
-- Dependencies: 180 2127
...
INSERT INTO precio (id, id_alimento, precio, fecha, cantidad, precio_venta, fecha_vencimiento, id_entrada_almacen) VALUES (27, 32, 1500, '2016-09-01', 1, 1800, '2016-09-03', 4);
INSERT INTO precio (id, id_alimento, precio, fecha, cantidad, precio_venta, fecha_vencimiento, id_entrada_almacen) VALUES (30, 33, 1200, '2016-10-02', 12, 1500, '2016-10-09', 6);
INSERT INTO precio (id, id_alimento, precio, fecha, cantidad, precio_venta, fecha_vencimiento, id_entrada_almacen) VALUES (31, 34, 600, '2016-10-02', 30, 800, '2016-11-04', 7);
INSERT INTO precio (id, id_alimento, precio, fecha, cantidad, precio_venta, fecha_vencimiento, id_entrada_almacen) VALUES (32, 35, 800, '2016-10-02', 50, 1200, '2016-11-06', 7);
INSERT INTO precio (id, id_alimento, precio, fecha, cantidad, precio_venta, fecha_vencimiento, id_entrada_almacen) VALUES (33, 36, 500, '2016-10-02', 12, 700, '2016-10-24', 6);
INSERT INTO precio (id, id_alimento, precio, fecha, cantidad, precio_venta, fecha_vencimiento, id_entrada_almacen) VALUES (34, 37, 1300, '2016-10-02', 12, 1600, '2016-10-10', 6);
INSERT INTO precio (id, id_alimento, precio, fecha, cantidad, precio_venta, fecha_vencimiento, id_entrada_almacen) VALUES (35, 38, 700, '2016-10-02', 50, 1000, '2016-10-31', 7);
...
SELECT pg_catalog.setval('precio_id_seq', 35, true);


--
-- TOC entry 2105 (class 0 OID 64080)
-- Dependencies: 182 2127
...
--
-- TOC entry 2107 (class 0 OID 64085)
-- Dependencies: 184 2127
...
--
-- TOC entry 2109 (class 0 OID 64090)
-- Dependencies: 186 2127
...
--
-- TOC entry 2112 (class 0 OID 64115)
-- Dependencies: 189 2127
...
SELECT pg_catalog.setval('tipo_alimento_id_seq', 7, true);


--
-- TOC entry 2114 (class 0 OID 64120)
-- Dependencies: 191 2127
...
--
-- TOC entry 2116 (class 0 OID 64125)
-- Dependencies: 193 2127
...
--
-- TOC entry 2124 (class 0 OID 115671)
-- Dependencies: 205 2127
-- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO "user" (id, username, auth_key, password_hash, password_reset_token, email, status, created_at, updated_at) VALUES (1, 'admin', 'Ner3V4mxxqqxkbn_LJBeO0R6QSU6MBa2', '$2y$13$IDjxe3EfVx7dAGxoPlY0iOexCxtqi9.Ctj44ZQJqDOGI3YwofU842', NULL, 'jiuly256@gmail.com', 10, 1474934518, 1474934518);
...
--
-- TOC entry 2118 (class 0 OID 64130)
-- Dependencies: 195 2127
-- Data for Name: usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO usuario (id, username, password, blnborrado, created_date, modified_date, created_by, modified_by, id_perfil, str_nombre, str_apellido, int_cedula) VALUES (3, 'usuario', 'f8032d5cae3de20fcec887f395ec9a6a', false, '2016-08-13', '2016-09-04', 1, 2, 2, 'usuario', '', NULL);
INSERT INTO usuario (id, username, password, blnborrado, created_date, modified_date, created_by, modified_by, id_perfil, str_nombre, str_apellido, int_cedula) VALUES (1, 'jirojas', '53a95281bf80b66231f952510f0a55d2', true, '2013-04-08', '2016-09-03', 1, 1, 1, 'Jiuly', 'Rojas', 18043559);
INSERT INTO usuario (id, username, password, blnborrado, created_date, modified_date, created_by, modified_by, id_perfil, str_nombre, str_apellido, int_cedula) VALUES (2, 'admin', '21232f297a57a5a743894a0e4a801fc3', false, '2016-08-13', '2016-09-04', 1, 1, 1, 'Admin', 'sistema', NULL);
INSERT INTO usuario (id, username, password, blnborrado, created_date, modified_date, created_by, modified_by, id_perfil, str_nombre, str_apellido, int_cedula) VALUES (5, 'ialvarez', '202cb962ac59075b964b07152d234b70', false, '2016-09-04', '2016-09-04', 1, 1, 1, 'isabel', 'alvarez', 123);
...
SELECT pg_catalog.setval('usuario_id_seq1', 5, true);


--
-- TOC entry 1923 (class 2606 OID 64166)
-- Dependencies: 161 161 2128
...
--
-- TOC entry 1925 (class 2606 OID 64168)
-- Dependencies: 163 163 2128
...
--
-- TOC entry 1929 (class 2606 OID 64170)
-- Dependencies: 166 166 2128
...
--
-- TOC entry 1927 (class 2606 OID 64172)
-- Dependencies: 165 165 2128
...
--
-- TOC entry 1969 (class 2606 OID 123879)
-- Dependencies: 207 207 2128
-- Name: dieta_subdieta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dieta_subdieta
    ADD CONSTRAINT dieta_subdieta_pkey PRIMARY KEY (id);


--
-- TOC entry 1931 (class 2606 OID 64174)
-- Dependencies: 170 170 2128
...
--
-- TOC entry 1957 (class 2606 OID 64560)
-- Dependencies: 198 198 2128
...
--
-- TOC entry 1933 (class 2606 OID 64176)
-- Dependencies: 172 172 2128
...
--
-- TOC entry 1959 (class 2606 OID 115668)
-- Dependencies: 203 203 2128
...
--
-- TOC entry 1935 (class 2606 OID 64178)
-- Dependencies: 174 174 2128
...
--
-- TOC entry 1937 (class 2606 OID 64180)
-- Dependencies: 176 176 2128
...
--
-- TOC entry 1939 (class 2606 OID 64182)
-- Dependencies: 178 178 2128
...
--
-- TOC entry 1941 (class 2606 OID 64184)
-- Dependencies: 180 180 2128
...
--
-- TOC entry 1943 (class 2606 OID 64186)
-- Dependencies: 182 182 2128
...
--
-- TOC entry 1945 (class 2606 OID 64188)
-- Dependencies: 184 184 2128
...
--
-- TOC entry 1947 (class 2606 OID 64190)
-- Dependencies: 186 186 2128
...
--
-- TOC entry 1949 (class 2606 OID 64200)
-- Dependencies: 189 189 2128
...
--
-- TOC entry 1951 (class 2606 OID 64202)
-- Dependencies: 191 191 2128
...
--
-- TOC entry 1953 (class 2606 OID 64204)
-- Dependencies: 193 193 2128
...
--
-- TOC entry 1961 (class 2606 OID 115686)
-- Dependencies: 205 205 2128
...
--
-- TOC entry 1963 (class 2606 OID 115684)
-- Dependencies: 205 205 2128
...
--
-- TOC entry 1965 (class 2606 OID 115680)
-- Dependencies: 205 205 2128
...
--
-- TOC entry 1967 (class 2606 OID 115682)
-- Dependencies: 205 205 2128
...
--
-- TOC entry 1955 (class 2606 OID 64206)
-- Dependencies: 195 195 2128
...
--
-- TOC entry 1970 (class 2606 OID 74731)
-- Dependencies: 161 189 1948 2128
...
--
-- TOC entry 1971 (class 2606 OID 64227)
-- Dependencies: 165 163 1924 2128
...
--
-- TOC entry 1972 (class 2606 OID 64232)
-- Dependencies: 165 1932 172 2128
...
--
-- TOC entry 1973 (class 2606 OID 64237)
-- Dependencies: 172 163 1924 2128
...
--
-- TOC entry 1974 (class 2606 OID 82900)
-- Dependencies: 193 176 1952 2128
...
--
-- TOC entry 1975 (class 2606 OID 64247)
-- Dependencies: 170 178 1930 2128
...
--
-- TOC entry 1976 (class 2606 OID 64252)
-- Dependencies: 1936 176 178 2128
...
--
-- TOC entry 1977 (class 2606 OID 74721)
-- Dependencies: 161 180 1922 2128
...
--
-- TOC entry 1978 (class 2606 OID 64262)
-- Dependencies: 191 1950 182 2128
...
-- Completed on 2016-10-04 07:07:47 VET
