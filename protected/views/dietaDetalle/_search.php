<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'id_dieta',array('class'=>'span5')); ?>
	...
	<?php echo $form->textFieldRow($model,'costo_gramos',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'precio_gramos',array('class'=>'span5')); ?>
