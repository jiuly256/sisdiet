<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->id_mascota),array('view','id'=>$data->id_mascota)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('longitud_medida')); ?>:</b>
	<?php echo CHtml::encode($data->longitud_medida); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('peso_medida')); ?>:</b>
	<?php echo CHtml::encode($data->peso_medida); ?>
	<br />
